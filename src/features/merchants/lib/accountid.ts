...
/**
 * Plain AccountId32 hex helpers. Kept WASM-free — dotli owns the vault now;
 * w3spay only parses the 32-byte hex AccountId surfaced by
 * `MerchantDestination.accountId32` entries.
 */
