...
/**
 * Wallet list page — `/wallet?tab=activity|receipts`. Reads the active tab from
 * the URL, wires `<WalletScreen>` to navigation, and opens individual records by
 * id (handled by the detail routes).
 */
