...
/**
 * Payment detail page — `/wallet/payment/$paymentId`. Looks the record up by id
 * from `usePaymentHistory()`; a missing id replaces back to the wallet list.
 * Reload-safe because the KvStore is the source of truth, not a passed-in record.
 */
