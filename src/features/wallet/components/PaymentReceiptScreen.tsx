...
/**
 * Payment detail view (tap a row on Activity). Renders the recorded merchant /
 * amount / timestamp, the receipt identifiers, and — when the record carries the
 * raw QR text — the original code re-rendered into a scannable SVG.
 */
...
export function PaymentReceiptScreen({ record, onBack }: PaymentReceiptScreenProps) {
  ...
  // Fall back to the shortened destination for dev-pay records (no merchant entry).
