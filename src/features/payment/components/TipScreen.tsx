...
/**
 * Tip selection screen. Owns its UI state and hands a resolved
 * integer-cent tip back to the parent on Continue/Skip.
 */
...
export interface TipScreenProps {
  ...
  /** Skip the tip step — equivalent to 0%; the parent treats both the same. */
  onSkip: () => void;
  /** Commit the chosen tip in integer cents (always non-negative). */
