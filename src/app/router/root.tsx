...
function AppShell() {
  ...
  switch (gate.kind) {
    ...
    case "hostUnavailable":
      ...
      break;
    default: {
      // `scanning` — ready. Hand off to the matched route, unless the balance
      // fetch failed (surface the retry screen). Only interrupt the scan
      // surface (flow === null); never yank a customer off mid-payment.
