...
/**
 * Host-wallet store. Single source of truth for the resolved product account,
 * signer, and live boot state.
 *
 * Inside a host: `getProductAccount` (also drives the SDK's
